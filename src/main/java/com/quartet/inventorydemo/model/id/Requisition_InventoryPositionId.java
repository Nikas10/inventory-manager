...
public class Requisition_InventoryPositionId implements Serializable {
    ...
    public Requisition_InventoryPositionId(@NotNull UUID inventoryPositionId, @NotNull UUID requisitionId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Requisition_InventoryPositionId)) return false;
