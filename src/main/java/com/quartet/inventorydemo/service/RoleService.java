...
public interface RoleService {
    ...
    Role addInventoryPositions(@NotNull @Valid UUID roleId, @NotNull @Valid Set<UUID> inventoryPositionIds);

    Role removeInventoryPositions(@NotNull @Valid UUID roleId, @NotNull @Valid Set<UUID> inventoryPositionIds);
}
