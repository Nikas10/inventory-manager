...
INSERT INTO oauth_client_details VALUES ('web',NULL,'inventory','read,write,trust','password,authorization_code,refresh_token,implicit','','USER,ADMIN',NULL,NULL,NULL,NULL);